...
type
  ...
  ModelSkeleton* {.importc, header: "raylib.h", completeStruct, bycopy.} = object ## Skeleton, animation bones hierarchy
    ...
    bindPose: ptr UncheckedArray[Transform] ## Bones base transformation (Transform[])
  ...
  Model* {.importc, header: "raylib.h", completeStruct, bycopy.} = object ## Model, meshes, materials and animation data
    ...
    currentPose: ptr UncheckedArray[Transform] ## Current animation pose (Transform[])
  ...
  ModelAnimPose* = ptr UncheckedArray[Transform] ## Anim pose, an array of Transform[]
...
func measureTextCodepointsImpl(font: Font, codepoints: ptr UncheckedArray[int32], length: int32, fontSize: float32, spacing: float32): Vector2 {.importc: "MeasureTextCodepoints".}
...
proc updateModelAnimation*(model: Model, animA: ModelAnimation, frameA: float32, animB: ModelAnimation, frameB: float32, blend: float32) {.importc: "UpdateModelAnimationEx", sideEffect.}
